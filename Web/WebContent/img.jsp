...
<% 
	...
	String img_name="index/"+id1+"_"+id2+"_"+id3+"_"+date+".html";
%>
<table height="200">
...
<table height="100">
    <form action="img.jsp" method="post">
				...
				<font color="#D90D10"><font size="+2">ID2：</font></font>
						...
						<option value="9377906286615510514">9377906286615510514</option> 
						<option value=<%=id2%> selected="selected"><%=id2%></option> 
						</select>
				<font color="#D90D10"><font size="+2">ID3：</font></font>
						...
						<option value="3377906288590000128">3377906282418510514</option>
						<option value="9377906286615510514">9377906286615510514</option> 
						<option value=<%=id3%> selected="selected"><%=id3%></option> 
						</select>
						
				<font color="#D90D10"><font size="+2">日期：</font></font>
						<select name="date" size="1">
						<option value="2016-03-09">2016-05-23</option>
  ...
  <tr align="center">
	<td ><iframe src=<%=img_name%> frameborder="0" width="1200" scrolling="False" height="550" leftmargin="0" topmargin="0"></iframe>
	</td>
  </tr>
</table>
</td></tr></table>
<table>
<tr  height="30"><td width="2000" align="center" bgcolor="#333333"><font color="#FFFFFF" size="-1" >COPYRIGHT &copy; 2016-2017&nbsp;&nbsp;&nbsp;&nbsp;智慧交通预测 .燕江弟、王志强、于林涵、李嘉禾  版权所有&nbsp;&nbsp;&nbsp;&nbsp;禁止拷贝、复制，违者必究。</font>
</td>
</tr>
</table>
