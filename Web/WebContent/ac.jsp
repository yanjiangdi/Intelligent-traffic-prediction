...
<% 
	...
	String img_name="index/"+id+"_"+date+"-ac.html";
%>
<table height="200">
...
<table height="100">
    <form action="ac.jsp" method="post">

		<p align="center"><font color="#D90D10"><font size="+2">ID：</font></font>
						<select name="id" size="1">
						<option value="4377906285343600514">4377906285343600514</option> 
						</select>
